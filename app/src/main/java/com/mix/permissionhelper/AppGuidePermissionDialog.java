 ...
 */
public class AppGuidePermissionDialog extends BaseAlertDialog {

    protected AppGuidePermissionDialog(@NonNull Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.app_dialog_guide_permission, null);
        ...
        rvGuidePermission.setAdapter(new RecyclerviewAdapter(getContext(), mPermissions));
